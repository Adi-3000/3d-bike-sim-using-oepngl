...
void welcome_window()
{
	...
	char Text1[38] = "VISVESVARAYA TECHNOLOGICAL UNIVERSITY";
	bitmap_output(-1.25, 1.8, 0.50, Text1);
	char Text2[18] = "BELGAUM,KARNATAKA";
	bitmap_output(-0.6, 1.6, 0.50, Text2);
	char Text4[11] = "Project On";
	bitmap_output(-0.3, 0.70, 0.50, Text4);
	char Text5[26] = "'SIMULATION OF A 3D BIKE'";
	bitmap_output(-0.85, 0.50, 0.50, Text5);
	char Text6[24] = "PLEASE PRESS S TO START";
	bitmap_output(-0.6, -1.5, 0.50, Text6);
	glutSwapBuffers();
	glFlush();
}
void operations_window()
{
	...
	glClearColor(0, 0, 0, 0);
	glColor3f(1.0, 1.0, 1.0);
	char Text7[45] = "OPERATIONS THAT CAN BE PERFORMED BY THE BIKE";
	bitmap_output(-1.25, 1.7, 0.50, Text7);
	char Text8[37] = "1. RESET THE CAMERA - USE 'R' OR 'r'";
	bitmap_output(-1.25, 1.2, 0.50, Text8);
	char Text9[33] = "2. ACCELERATE THE BIKE - USE '+'";
	bitmap_output(-1.25, 1.0, 0.50, Text9);
	char Text10[35] = "3. DEACCELERATE THE BIKE - USE '-'";
	bitmap_output(-1.25, 0.8, 0.50, Text10);
	char Text11[24] = "4. TURN RIGHT - USE '2'";
	bitmap_output(-1.25, 0.6, 0.50, Text11);
	char Text12[23] = "5. TURN LEFT - USE '1'";
	bitmap_output(-1.25, 0.4, 0.50, Text12);
	char Text13[32] = "6. ZOOM IN - USE 'UPWARD ARROW'";
	bitmap_output(-1.25, 0.2, 0.50, Text13);
	char Text14[35] = "7. ZOOM OUT - USE 'DOWNWARD ARROW'";
	bitmap_output(-1.25, 0.0, 0.50, Text14);
	char Text15[32] = "8. MOVE LEFT - USE 'LEFT ARROW'";
	bitmap_output(-1.25, -0.2, 0.50, Text15);
	char Text16[34] = "9. MOVE RIGHT - USE 'RIGHT ARROW'";
	bitmap_output(-1.25, -0.4, 0.50, Text16);
	char Text17[45] = "10. USE MOUSE TO CHANGE THE ANGLE OF VIEWING";
	bitmap_output(-1.25, -0.6, 0.50, Text17);
	char Text18[27] = "PLEASE PRESS C TO CONTINUE";
	bitmap_output(-1.25, -1.0, 0.50, Text18);
	glutSwapBuffers();
	glFlush();
}
